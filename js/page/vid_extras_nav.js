...
function vidMenuClick()
{
	...
	else if (vid_index == 2)
	{
		...
		document.getElementById('mov').innerHTML = '<embed src="video/323_4_0_bsc01.mp4" autostart="true" width="797" height="447" ShowControls="0" ShowStatusBar="0" ShowDisplay="0" Loop="true"></embed><p><b>Dexter</b> Early Cuts</p>';
	...
	{
		document.getElementById('mov').innerHTML = '<embed src="video/323_4_0_int12_clip.mp4" autostart="true" width="797" height="447" ShowControls="0" ShowStatusBar="0" ShowDisplay="0" Loop="true"><p><b>John Lithgow:</b> Video Chat';
		videoItems[clickedIndex].className = "deselected";
		clickedIndex = 4;
	}
